IntercomRails.config do |config|
  # == Intercom app_id
  #
  config.app_id = ENV["INTERCOM_APP_ID"] || "l5c1kmji"

  # == Intercom secret key
  # This is required to enable secure mode, you can find it on your Setup
  # guide in the "Secure Mode" step.
  #
  config.api_secret = "DuPnI8YCHwW7BYorYBwe5FTS0yV__Z2YEBrHvAtW"
  ...
  #
  config.api_key = "9973822ba0080cf741063b280aa18fab5f9001de"
  ...
  #
  config.user.current = Proc.new { current_buyer }
